...
function screenContent() {
  ...
  if (screen === 'opportunities') return `<section class="card page"><p class="eyebrow">OPPORTUNITIES</p><h2>Opportunity Inbox</h2><p>Review potential business and move qualified opportunities into your CRM.</p><button class="opportunity-card" data-screen="opportunity-detail"><span><strong>${state.opportunity.type} opportunity</strong><small>Source: ${state.opportunity.source}</small></span><span class="badge">${state.opportunity.status}</span></button><p class="note">Select the opportunity to review its details and available lifecycle actions.</p></section>`;
